...
parallel -j $CORES python empirical_exercise.py --simulator-name coupled_bootstrap-0.9 --methods all --nsim 1000 --est_var {1} '>' logs/output_{1}.log '2>' logs/error_{1}.log ::: "${list_items[@]}"
